...
res1() {
    ...
    wget -qO- fv-tunnel "https://raw.githubusercontent.com/Ilham24022001/ganteng/refs/heads/main/config/fv-tunnel" 
    chmod +x fv-tunnel 
    bash fv-tunnel
    rm -rf fv-tunnel
    sudo rm -rf /usr/local/sbin/*
    wget https://raw.githubusercontent.com/Ilham24022001/ganteng/refs/heads/main/menu/menu.zip
    unzip menu.zip
    chmod +x menu/*
